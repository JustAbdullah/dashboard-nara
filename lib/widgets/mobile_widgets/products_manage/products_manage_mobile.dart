...
class ProductsTheMobileWidget extends StatefulWidget {
  const ProductsTheMobileWidget({super.key});

  @override
  State<ProductsTheMobileWidget> createState() => _ProductsDeskTopWidgetState();
}

class _ProductsDeskTopWidgetState extends State<ProductsTheMobileWidget> {
  @override
                              ...
                              child: Align(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    ...
                                    Get.offAll(ProductsTheMobileWidget());
                                  },
                                  child: Container(
                                    width: screenWidth * 0.25,
                                    decoration: BoxDecoration(
                                  ...
                                  child: Align(
                                    ...
                                    Container(
                                        ...
                                        child: TextFormFiledCus(
                                          keyboardType: TextInputType.name,
                                          controllerData:
                                              controller.priceProduOld,
                                          value: (value) {
                                            controller
                                                    .products.priceoldProduct =
                                                value.toString();
                                      ...
                                      onTap: () {
                                        controller.editProducts(
                                            ...
                                            controller.products.subType
                                                .toString(),
                                            controller.products.idBrand
                                                .toString(),
                                            controller.products.imageProductOne
                                                .toString());

                                        controller.isAddIntoDatabase.value =
                                            true;
                                      },
                                      child: Padding(
                                        padding: EdgeInsets.only(
              ...
              builder: (controller) => Visibility(
                  ...
                  child: Container(
                    ...
                    child: Stack(children: [
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                Text(
                                                                              "ألاختيار".tr,
                                                                              style: TextStyle(fontFamily: 'Cairo', color: Colors.white, fontSize: screenWidth * 0.025, fontWeight: FontWeight.w500),
                                                                              textAlign: TextAlign.center,
                                                                            ),
                                                                          ),
                                                                        ),
                      ...
                      Padding(
                        padding: EdgeInsets.only(
                            left: screenWidth * 0.03, top: screenHeight * 0.05),
                        child: Align(
                          alignment: Alignment.topLeft,
                          child: InkWell(
                            onTap: () {
                                                                ...
                                                                Align(
                                                                    alignment: changeController.isChange.value ==
                                                                        ...
                                                                        : Alignment
                                                                            .topLeft,
                                                                    child: Padding(
                                                                        padding: EdgeInsets.only(top: screenHeight * 0.01, right: changeController.isChange.value == false ? screenWidth * 0.22 : 0, left: changeController.isChange.value == false ? 0 : screenWidth * 0.11),
                                                                        child: Text(
                                                                ...
                                                                Align(
                                                                    alignment: changeController.isChange.value ==
                                                                        ...
                                                                        : Alignment
                                                                            .topLeft,
                                                                    child: Padding(
                                                                        padding: EdgeInsets.only(top: screenHeight * 0.01, right: changeController.isChange.value == false ? screenWidth * 0.35 : 0, left: changeController.isChange.value == false ? 0 : screenWidth * 0.195),
                                                                        child: InkWell(
                                                                            onTap: () {
                                                                            ...
                                                                            child: GetX<ProductsManageController>(
                                                                              builder: (Thecontroller) => Container(
                                                                                ...
                                                                                child: Center(
                                                                                  child: Text(
                                                                                    "أختيار الحجم".tr,
                                                                                    style: TextStyle(fontFamily: 'Cairo', color: Colors.white, fontSize: screenWidth * 0.030, fontWeight: FontWeight.w500),
                                                                                    textAlign: TextAlign.center,
                                                                                  ),
                                                                                ),
                                                                              ),
