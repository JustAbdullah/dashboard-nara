...
class addProductsMobileWidget extends StatefulWidget {
  const addProductsMobileWidget({Key? key}) : super(key: key);

  @override
  State<addProductsMobileWidget> createState() =>
      _addProductsDesktopWidgetState();
}

class _addProductsDesktopWidgetState extends State<addProductsMobileWidget> {
  @override
                      ...
                      onTap: () {
                        addProductsController.addTheProducts(
                          ...
                          addProductsController.whatIsTheSubTypeOFProduct.value
                              .toString(),
                          addProductsController.theBrand.value.toString(),
                        );
