...
class ManageDeskTopOffers extends StatefulWidget {
  const ManageDeskTopOffers({super.key});

  @override
  State<ManageDeskTopOffers> createState() => _ManageDeskTopOffersState();
}

class _ManageDeskTopOffersState extends State<ManageDeskTopOffers> {
  @override
                                  ...
                                  onTap: () {
                                    Future.delayed(Duration(milliseconds: 700),
                                      ...
                                      controller.deleteTheOffers(controller
                                          .offer.id_offers
                                          .toString());
                                      Get.offAll(ManageDeskTopOffers());
                                      controller.showOptions.value = false;
                                    });
                                  },
                                  child: Container(
