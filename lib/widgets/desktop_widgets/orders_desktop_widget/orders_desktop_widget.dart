...
class OrdersDeskTopWidget extends StatelessWidget {
  const OrdersDeskTopWidget({super.key});
                                ...
                                child: InkWell(
                                  onTap: () {
                                    ...
                                    Future.delayed(Duration(milliseconds: 700),
                                        () async {
                                      Get.offAll(OrdersDeskTopWidget());
                                    });
                                  },
                                  child: Container(
                                    width: screenWidth * 0.1,
                                      ...
                                      itemBuilder: (context, i) {
                                        ...
                                        controller
                                            ...
                                            snapshot.data['data'][i]
                                                    ['id_shoppingCart']
                                                .toString();
                                        controller.shoppingCart.quantity_cart =
                                            snapshot.data['data'][i]
                                                    ['quantity_cart']
                                                .toString();
                                                                  ...
                                                                  Container(
                                                                      ...
                                                                      height:
                                                                          screenHeight *
                                                                              0.07,
                                                                      child: FutureBuilder(
                                                                          future: ordersManageController.getColorShoppingcart(snapshot.data['data'][i]['id_shoppingCart'].toString()),
                                                                          builder: (BuildContext context, AsyncSnapshot snapshot) {
                                                                                      ...
                                                                                      return Padding(
                                                                                          ...
                                                                                          child: Padding(
                                                                                              ...
                                                                                              child: Container(
                                                                                                ...
                                                                                                decoration: BoxDecoration(color: snapshot.data['data'][i]['color'].toString() != "0" ? Color(int.parse(snapshot.data['data'][i]['color'].toString())) : Colors.white, shape: BoxShape.circle),
                                                                                              )));
                                                                                    } else {
                                                                                      return Center(child: Center(child: CircularProgressIndicator(color: Colors.red)));
                                                                                    }
                                                                                  });
                                                                            } else {
                                                                              return Center(child: Center(child: CircularProgressIndicator(color: Colors.red)));
                                                                  ...
                                                                  Container(
                                                                      ...
                                                                      height:
                                                                          screenHeight *
                                                                              0.07,
                                                                      child: FutureBuilder(
                                                                          future: ordersManageController.getSizesShoppingcart(snapshot.data['data'][i]['id_shoppingCart'].toString()),
                                                                          builder: (BuildContext context, AsyncSnapshot snapshot) {
                                                                            if (snapshot.hasError) {
                                                                              return Text('Something went wrong');
                                                                            } else if (snapshot.hasData) {
                                                                              return ListView.builder(
                                                                                  ...
                                                                                  itemBuilder: (context, i) {
                                                                                    if (snapshot.hasData) {
                                                                                      return Padding(padding: EdgeInsets.only(top: screenHeight * 0.03, bottom: screenHeight * 0.01), child: Padding(padding: EdgeInsets.symmetric(horizontal: screenWidth * 0.01), child: Text(snapshot.data['data'][i]['size'].toString(), style: TextStyle(fontSize: screenWidth * 0.012, fontFamily: 'Cairo', color: Colors.black))));
                                                                                    } else {
                                                                                      return Center(child: Center(child: CircularProgressIndicator(color: Colors.red)));
                                                                                    }
                                                                                  });
